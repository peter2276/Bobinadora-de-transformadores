...
# 150 "./mcc_generated_files/ccp2.h"
_Bool CCP2_IsCapturedDataReady(void);
   ...
   if(CommandList->size<50){
         ...
         if(numBytesRead>0){
            ...
            if(strlen(lastToken)!=0){
               ...
               Fila_Agregar(CommandList,readTokens[0],strlen(readTokens[0]));
...
void executeCommand(Fila_T* CommandList){
   ...
   if(busy==0){
         if(CommandList->size>0){
            ...
            sprintf(writeBuffer,"%sX%sX%d",writeBuffer,strCommand,CommandList->size);
