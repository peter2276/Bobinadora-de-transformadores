...
# 1 "/Applications/microchip/mplabx/v6.00/packs/Microchip/PIC18F-K_DFP/1.5.114/xc8/pic/include/inline.h" 1 3
...
# 259 "/Applications/microchip/xc8/v2.36/pic/sources/c99/common/doprnt.c"
...
# 568 "/Applications/microchip/xc8/v2.36/pic/sources/c99/common/doprnt.c"
...
# 692 "/Applications/microchip/xc8/v2.36/pic/sources/c99/common/doprnt.c"
static int vfpfcnvrt(FILE *fp, char *fmt[], va_list ap)
{
    ...
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 762 "/Applications/microchip/xc8/v2.36/pic/sources/c99/common/doprnt.c"
        if ((*fmt)[0] == '.') {
            prec = 0;
            ++*fmt;
            if ((*fmt)[0] == '*') {
...
# 814 "/Applications/microchip/xc8/v2.36/pic/sources/c99/common/doprnt.c"
        if (*fmt[0] == 'c') {
            ++*fmt;
            c = (unsigned char)(*(int *)__va_arg(*(int **)ap, (int)0));
            return ctoa(fp, c);
        }
# 847 "/Applications/microchip/xc8/v2.36/pic/sources/c99/common/doprnt.c"
        if ((*fmt[0] == 'd') || (*fmt[0] == 'i')) {
...
# 942 "/Applications/microchip/xc8/v2.36/pic/sources/c99/common/doprnt.c"
        if (ct[0] == 'f') {
...
# 1171 "/Applications/microchip/xc8/v2.36/pic/sources/c99/common/doprnt.c"
